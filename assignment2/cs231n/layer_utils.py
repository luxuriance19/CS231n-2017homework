...
def affine_batchnorm_relu_forward(x, w, b, gamma, beta, bn_param):
    ...
    - x: Input to the affine layer
    - w, b: Weights for the affine layer
    - gamma, beta: Weigths for batch normalization layer
...
def affine_relu_dropout_backward(dout, cache):
    """
    Backward pass for the affine-relu-dropout_backward convenience layer
    """
    fc_cache, relu_cache, dropout_cache = cache
    da_dropout = dropout_backward(dout, dropout_cache)
    dx, dw, db = affine_relu_backward(da_dropout, (fc_cache, relu_cache))
    return dx, dw, db

def affine_batchnorm_relu_dropout_forward(x, w, b, gamma, beta, bn_param, dropout_params):
    """
    Convenience layer that combines affine transform, batch normalization and ReLU
    ...
    - cache: Object to give to the backward pass
    """
    a, (fc_cache, bn_cache, relu_cache) = affine_batchnorm_relu_forward(x, w, b, gamma, beta, bn_param)
    out, dropout_cache = dropout_forward(a, dropout_params)
